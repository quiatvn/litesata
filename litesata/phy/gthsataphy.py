...
class GTHLiteSATAPHYCRG(Module):
    def __init__(self, refclk, pads, gth, gen):
        ...
        tx_mmcm_clkout_freq = {
            "gen1":  75e6/(gth.data_width/16),
            "gen2": 150e6/(gth.data_width/16),
            "gen3": 300e6/(gth.data_width/16),
        }
        #self.submodules += tx_mmcm
        #self.specials += Instance("BUFG", i_I=gth.txoutclk, o_O=tx_mmcm_clkin)
